...
export function CustomersTableRowSkeleton() {
  return (
    <tr className="w-full border-b border-gray-100 last-of-type:border-none 
      ...
      {/* Email */}
      <td className="relative whitespace-nowrap px-3 py-3 overflow-hidden">
        <div className={`h-6 w-32 rounded bg-gray-100 ${shimmer}`}></div>
      </td>
      {/* Total Invoices */}
      <td className="relative whitespace-nowrap px-3 py-3 overflow-hidden">
        <div className={`h-6 w-16 rounded bg-gray-100 ${shimmer}`}></div>
      </td>
      {/* Total Pending */}
      <td className="relative whitespace-nowrap px-3 py-3 overflow-hidden">
        <div className={`h-6 w-16 rounded bg-gray-100 ${shimmer}`}></div>
